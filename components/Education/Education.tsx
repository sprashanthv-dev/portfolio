...
const Education = () => {
  ...
  return (
    <>
      ...
      <div>
        <div
          className={`flex flex-col items-center justify-around md:flex-row p-5 border-4 rounded shadow-lg ${theme.type === "light" ? "border-light-mode-dark-color" : "border-dark-mode-light-bg"} m-5`}>
        ...
        <div
          className={`flex flex-col items-center justify-around md:flex-row p-5 border-4 rounded shadow-lg ${theme.type === "light" ? "border-light-mode-dark-color" : "border-dark-mode-light-bg"} mx-5 my-10`}>
