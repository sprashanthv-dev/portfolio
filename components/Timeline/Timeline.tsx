      ...
      <VerticalTimeline
        ...
        {data.map((item, index) => (
          <VerticalTimelineElement
            key={item.id}
            className={index % 2 === 0 ? evenIdxConfig.className : oddIdxConfig.className}
            contentStyle={index % 2 === 0 ? evenIdxConfig.contentStyle : oddIdxConfig.contentStyle}
            contentArrowStyle={index % 2 === 0 ? evenIdxConfig.contentArrowStyle : oddIdxConfig.contentArrowStyle}
            iconStyle={index % 2 === 0 ? evenIdxConfig.iconStyle : oddIdxConfig.iconStyle}
            date={item.period}>
            <h3 className={`vertical-timeline-element-title ${styles.main_title}`}>{item.title}</h3>
